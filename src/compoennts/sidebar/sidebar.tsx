    ...
    return (
        <Layout className="overflow-hidden">
            <Header
                ...
                <Button className={cn(
                    "md:hidden"
                )} onClick={toggleSidebar} type="dashed">Menu</Button>
            </Header>
            ...
            <Layout className={cn(
                ...
                >
                    ...
                    <div className={cn(
                        ...
                        <h2>Logo</h2>
                        <Button className="border-none" onClick={toggleSidebar} type="default">
                            <CloseOutlined />
                        </Button>
                    </div>
                    <Menu mode="inline" defaultSelectedKeys={['sidebar-menu-home']} items={menuItems} />
