        ...
        <>
            ...
            <div className={cn(
                ...
                <Button
                    ...
                    className={cn(
                        "my-[40px]"
                    )} size="large" type="primary" block>Log In </Button>

                <p className="mt-4">Don't have an account?<a className="ml-2 underline" href="/">Get in Touch</a> </p>
            </div>
            <div className={cn(
                ...
                <a className={cn(
                    "inline text-base underline mb-[24px]",
                    "md:hidden"
                )} href="/">Go to Main Site</a>
                <p>© 2023 IDEON TECHNOLOGIES INC. ALL RIGHTS RESERVED</p>
                <div className={cn(
                    "flex items-center gap-x-4 mt-[12px]",
                    "md:mt-[0px] "
                )}>
                    <a className="underline" href="/">PRIVACY POLICY</a>
                    <a className="underline" href="/"> CODE OF ETHICS AND CONDUCT</a>
                </div>
            </div>
